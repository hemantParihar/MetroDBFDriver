...
public class ExpressionNode extends ASTNode {
    ...
    // For scalar function calls: name(args...)
    private String functionName;
    private java.util.List<ExpressionNode> arguments;

    private boolean isRecno = false;
    private int recnoValue = -1;

    // Aggregate appearing inside an expression, e.g. MAX(lote)+1.
    private boolean aggregate = false;
    private String aggregateFunction;   // COUNT/SUM/AVG/MIN/MAX
    private ExpressionNode aggregateArg; // null for COUNT(*)
    private boolean star = false;        // COUNT(*)
    private boolean distinct = false;

    /** Marks this node as an aggregate call used within a larger expression. */
    public void setAggregate(String function, ExpressionNode arg, boolean star, boolean distinct) {
        this.aggregate = true;
        this.aggregateFunction = function == null ? null : function.toUpperCase();
        this.aggregateArg = arg;
        this.star = star;
    ...
    public ExpressionNode getAggregateArg() {
        return aggregateArg;
    }
    ...
    public void setFunction(String functionName, java.util.List<ExpressionNode> arguments) {
